...
The accelerometer dataset ()includes the motion per minute data of the
1440 minutes in a day for 5 full weeks.
...
Load, tidy, and otherwise wrangle the . Your final set should include
all originally observed variables and values; have useful variable
names; include a weekday vs weekend variable; and encode with reasonable
variable classes. Describe the resulting set (e.g. what variables exist,
